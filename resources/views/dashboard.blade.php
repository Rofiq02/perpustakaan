...
<div class="box box-info">
          ...
          <div class="col-md-6">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  ...
                  <div class="box-tools pull-right">
                    <span class="label label-danger">{{ $jumlahusers }}</span>
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                    </button>
                ...
                <div class="box-body no-padding">
                  ...
                  @foreach ($users as $us)
                    <li>
                      <img src="{{ asset('img/'.$us->avatar) }}" alt="User Image">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              @foreach($tpbuku as $tp)
                <li class="item">
                  <div class="product-img">
                    <img src="{{ asset('img/'.$tp->cover) }}" alt="Product Image">
                  </div>
                  <div class="product-info">
                    <a href="javascript:void(0)" class="product-title">{{ $tp->judul }}
                    <span class="product-description">
                    {{ App\MGlobal::Get_Penerbit($tp->kd_penerbit)." / ".$tp->tempat_terbit."/".$tp->tahun_terbit }}
                        </span>
                  </div>
                </li>
              @endforeach
            ...
            <!-- /.box-body -->
            <div class="box-footer text-center">
              <a href="{{ url('buku') }}" class="uppercase">View All Books</a>
            </div>
            <!-- /.box-footer -->
          </div>
          </div>
